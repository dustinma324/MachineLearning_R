...
```{r, make_prediction_grid_01, eval=FALSE}
...
```{r, make_sonar_boxplots, eval=FALSE}
Sonar %>% 
  tibble::rowid_to_column("obs_id") %>% 
...
```{r, make_sonar_test_grid, eval=FALSE}
...
```{r, show_test_grid_combo_counts, eval=FALSE}
test_sonar_grid %>% 
...
```{r, solution_06d_b, eval=FALSE}
pred_test_prob_sonar_rf %>% class()
```

```{r, solution_06d_c, eval=FALSE}
